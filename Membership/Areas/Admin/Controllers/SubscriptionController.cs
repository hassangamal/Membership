...
namespace Membership.Areas.Admin.Controllers
{
    public class SubscriptionController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "SubscriptionID,Title,Descriptions,RegistrationCode")] Subscription subscription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "SubscriptionID,Title,Descriptions,RegistrationCode")] Subscription subscription)
        {
            if (ModelState.IsValid)
            {
