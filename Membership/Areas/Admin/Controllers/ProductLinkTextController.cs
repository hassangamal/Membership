...
namespace Membership.Areas.Admin.Controllers
{
    public class ProductLinkTextController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ProductLinkTextID,Title")] ProductLinkText productLinkText)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProductLinkTextID,Title")] ProductLinkText productLinkText)
        {
            if (ModelState.IsValid)
            {
