...
namespace Membership.Areas.Admin.Controllers
{
    public class SectionController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "SectionID,Title")] Section section)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "SectionID,Title")] Section section)
        {
            if (ModelState.IsValid)
            {
