...
namespace Membership.Areas.Admin.Controllers
{
    public class ItemTypeController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ItemTypeID,Title")] ItemType itemType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ItemTypeID,Title")] ItemType itemType)
        {
            if (ModelState.IsValid)
            {
