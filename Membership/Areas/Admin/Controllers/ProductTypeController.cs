...
namespace Membership.Areas.Admin.Controllers
{
    public class ProductTypeController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ProductTypeID,Title")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ProductTypeID,Title")] ProductType productType)
        {
            if (ModelState.IsValid)
            {
